...
if __name__ == "__main__":
    ...
    control_MPC = control_ctr.MPC_control(5)  # Initialize controller
    ...
    while sim.getSimulationTime() < this_sim.max_simtime:
        ...
        xl1, yl1, zl1 = control_MPC.calculate_PL(robot1_pos[0], robot1_pos[1], robot1_pos[2], robots1_orintation[2], robots1_orintation[1], robots1_orintation[0], h1)
        xr1, yr1, zr1 = control_MPC.calculate_PR(robot1_pos[0], robot1_pos[1], robot1_pos[2], robots1_orintation[2], robots1_orintation[1], robots1_orintation[0])
        ...
        xl2, yl2, zl2 = control_MPC.calculate_PL(robot2_pos[0], robot2_pos[1], robot2_pos[2], robots2_orintation[2], robots2_orintation[1], robots2_orintation[0], h2)
        xr2, yr2, zr2 = control_MPC.calculate_PR(robot2_pos[0], robot2_pos[1], robot2_pos[2], robots2_orintation[2], robots2_orintation[1], robots2_orintation[0])
        ...
        xl3, yl3, zl3 = control_MPC.calculate_PL(robot3_pos[0], robot3_pos[1], robot3_pos[2], robots3_orintation[2], robots3_orintation[1], robots3_orintation[0], h3)
        xr3, yr3, zr3 = control_MPC.calculate_PR(robot3_pos[0], robot3_pos[1], robot3_pos[2], robots3_orintation[2], robots3_orintation[1], robots3_orintation[0])
        ...
        xl4, yl4, zl4 = control_MPC.calculate_PL(robot4_pos[0], robot4_pos[1], robot4_pos[2], robots4_orintation[2], robots4_orintation[1], robots4_orintation[0], h4)
        xr4, yr4, zr4 = control_MPC.calculate_PR(robot4_pos[0], robot4_pos[1], robot4_pos[2], robots4_orintation[2], robots4_orintation[1], robots4_orintation[0])
        ...
        ## control the robot 1
        B1 = control_MPC.caluculate_M(robots1_orintation[2], robots1_orintation[1], robots1_orintation[0], h1)
        D1 = control_MPC.calculate_D(robots1_orintation[2], robots1_orintation[1], robots1_orintation[0], h1)
        B1 = np.round(B1, round)
        D1 = np.round(D1, round)
        ...
        x_ref1 = np.array([x_leader - 0.25, y_leader - 0.25, sub_controller.h,
                    x_leader - 0.25 + control_MPC.L, 
                    y_leader - 0.25])
        x_error1 = x1 - x_ref1
        err1 = [x_error1[0]*0.01, x_error1[1], x_error1[2], x_error1[3]*0.01, x_error1[4]] 
        u1 = control_MPC.compute_MPC(x1, x_ref1, B1)
        u1 = np.clip(u1, sub_controller.u_min, sub_controller.u_max)


        ## control the robot 2
        B2 = control_MPC.caluculate_M(robots2_orintation[2], robots2_orintation[1], robots2_orintation[0], h2)
        B2 = np.round(B2, round)
        D2 = control_MPC.calculate_D(robots2_orintation[2], robots2_orintation[1], robots2_orintation[0], h2)
        D2 = np.round(D2, round)
        ...
        u2 = control_MPC.compute_MPC(x2, x_ref2, B2)
        u2 = np.clip(u2, sub_controller.u_min, sub_controller.u_max)

        ## control the robot 3
        B3 = control_MPC.caluculate_M(robots3_orintation[2], robots3_orintation[1], robots3_orintation[0], h3)
        B3 = np.round(B3, round)
        D3 = control_MPC.calculate_D(robots3_orintation[2], robots3_orintation[1], robots3_orintation[0], h3)
        D3 = np.round(D3, round)
        ...
        u3 = control_MPC.compute_MPC(x3, x_ref3, B3)
        u3 = np.clip(u3, sub_controller.u_min, sub_controller.u_max)

        ## control the robot 4
        B4 = control_MPC.caluculate_M(robots4_orintation[2], robots4_orintation[1], robots4_orintation[0], h4)
        B4 = np.round(B4, round)
        D4 = control_MPC.calculate_D(robots4_orintation[2], robots4_orintation[1], robots4_orintation[0], h4)
        D4 = np.round(D4, round)
        ...
        u4 = control_MPC.compute_MPC(x4, x_ref4, B4)
    ...
    filename = f'./new_data/MPC_data_sce1_{current_time}.csv'
